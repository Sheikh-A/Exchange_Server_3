...
def trade():
    if request.method == "POST":
        ...
        if platform == "Algorand":
            ...
            trade_data = {'platform':platform,'sender_pk': pk, 'receiver_pk': receiver_pk, 'buy_currency':buy_currency,'sell_currency': sell_currency,'buy_amount':buy_amount,'sell_amount':sell_amount }
            #JSON DUMPS
